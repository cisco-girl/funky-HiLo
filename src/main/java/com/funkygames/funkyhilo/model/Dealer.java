...
public class Dealer {
	...
	public Dealer() {
		// when a new dealer is created, give a new deck of cards
		this.deck = new Deck();
	}
	...
	public Card deal() {
		// when dealer is called, draw a card from the deck
		Card card = null;
		try {
			card = deck.drawCard();
			...
			try {
				...
				throw new IllegalStateException("a new deck should have at least one card");
